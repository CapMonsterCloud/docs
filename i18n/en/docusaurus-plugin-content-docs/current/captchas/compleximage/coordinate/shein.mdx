---
sidebar_label: shein
title: 'Recognition and solving shein | API'
description: 'Use the ComplexImageTask method for automatic recognition and solving of shein via the CapMonster Cloud API.'
---
