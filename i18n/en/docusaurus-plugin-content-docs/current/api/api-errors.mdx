...
The CAPTCHA could not be solved. This is usually a temporary condition — try creating the task again. For image CAPTCHAs, repeated failures may mean the image cannot be recognized correctly: it may be too noisy, corrupted, or missing an answer. You are not charged for unsolved tasks.
