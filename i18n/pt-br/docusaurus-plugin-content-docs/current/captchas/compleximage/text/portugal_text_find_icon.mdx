...
> IMPORTANTE: obtenha a imagem em base64 diretamente antes de criar a tarefa para evitar erros durante a resolução (veja a seção [Exemplos automatizados de reconhecimento e resolução](#exemplos-automatizados-de-reconhecimento-e-resolução)).
</span>
<br />
