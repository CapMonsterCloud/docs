...
>  IMPORTANTE: os valores desses parâmetros são dinâmicos — eles mudam a cada renderização da página com Alibaba Cloud Captcha.  
> Extraia-os imediatamente antes de criar a tarefa para evitar erros na resolução.
</span>
<br />
