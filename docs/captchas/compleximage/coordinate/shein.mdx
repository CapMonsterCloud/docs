---
sidebar_label: shein
title: 'Распознавание и решение shein | API'
description: 'Используйте метод ComplexImageTask для автоматического распознавания и решения shein через API Capmonster Cloud.'
---
