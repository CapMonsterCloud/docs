...
>  ВАЖНО: получайте base64 готового изображения непосредственно перед созданием задачи, чтобы избежать ошибок при решении (см. раздел [Как получить base64](#как-получить-base64)).
</span>
<br />
